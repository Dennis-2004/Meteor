		...
		for (int j = 0; j < columns; j++)
		{
			...
			for (int k = 0; k < common_dim; k++)
			{
				...
				temp3[i * columns + j].first += tmp_a[i * common_dim + k].first * tmp_b[k * columns + j].first +
												tmp_a[i * common_dim + k].first * tmp_b[k * columns + j].second.first +
												tmp_a[i * common_dim + k].second.first * tmp_b[k * columns + j].first +
												tmp_a[i * common_dim + k].second.first * tmp_b[k * columns + j].second.first - 0;

				temp3[i * columns + j].second += tmp_a[i * common_dim + k].first * tmp_b[k * columns + j].first +
												tmp_a[i * common_dim + k].first * tmp_b[k * columns + j].second.second +
												tmp_a[i * common_dim + k].second.second * tmp_b[k * columns + j].first +
												tmp_a[i * common_dim + k].second.second * tmp_b[k * columns + j].second.second - 0;
